...
export function AddColumnModal({ onClose, onAdd }: AddColumnModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-end justify-center md:items-center p-0 md:p-4 z-[100] animate-in fade-in duration-200">
            <div className="bg-[#191919] border-t border-x md:border border-[#2f2f2f] w-full md:w-full md:max-w-xl rounded-t-2xl md:rounded-lg shadow-2xl overflow-hidden animate-in slide-in-from-bottom duration-300 md:duration-200 md:zoom-in-95">
